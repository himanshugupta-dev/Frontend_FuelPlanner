      ...
      >
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden items-center gap-8 text-sm font-medium md:flex" style={{ color: "var(--gn-muted)" }}>
            <a href="#features" className="hover:opacity-80" style={{ transition: "opacity 0.2s" }}>Features</a>
            <a href="#how-it-works" className="hover:opacity-80" style={{ transition: "opacity 0.2s" }}>How It Works</a>
            <a href="#testimonials" className="hover:opacity-80" style={{ transition: "opacity 0.2s" }}>Testimonials</a>
          </div>
